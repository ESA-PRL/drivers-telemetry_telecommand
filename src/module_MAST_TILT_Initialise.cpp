...
namespace ControllerModelNamespace {
  ...
  orc_Mod_MAST_TILT_Initialise::orc_Mod_MAST_TILT_Initialise (/* ModuleTask* mt,
							    int indexclk */)
  //    : ModuleAlgo ("orc_Mod_MAST_TILT_Initialise", mt, indexclk)
  {
    //    PRINT1("** orc_Mod_MAST_TILT_Initialise constructor")
  }
  
  orc_Mod_MAST_TILT_Initialise::~orc_Mod_MAST_TILT_Initialise ()
  {
    //    PRINT1( "** orc_Mod_MAST_TILT_Initialise destructor" )
  }
  ...
  void orc_Mod_MAST_TILT_Initialise::reparam (char *params)
  {
    //  fprintf( stderr, "MAST_TILT_Initialise:: reparam\n" );
    // #include   "MAST_TILT_Initialise/user_code/reparam_code.c"
  }
  ...
  void orc_Mod_MAST_TILT_Initialise::init ()
  {
    ...
    if (action_exec_status != ACTION_RET_OK) {
      fprintf(stderr, "In MAST_TILT_Initialise::init() action status = error\n");
      //      moduleSendEvent("MAST_TILT_Initialise_exc;");
      return;
    }
    ...
    // get the action Id
    rtId = 0.0; // Mt_ptr->GetRobotTaskPtr()->GetId();
    ...
    /*
      ...
      fprintf(stderr, "In MAST_TILT_Initialise::init() Mast not in MAST_OPER_MODE_OFF mode\n");
      MastState[ABORT_INDEX]       = ACTION_RET_ERROR;
    ...
    */
    ...
    //
    MAST_TILT_Initialise_prec = SET_EVENT;
    //    moduleSendEvent("MAST_TILT_Initialise_prec;");
  }
  ...
  void orc_Mod_MAST_TILT_Initialise::compute ()
  {
	...
	MastState[MAST_TILT_STATUS_INDEX] = MAST_OPER_MODE_TILT_STNDBY;
      ...
      //
      MAST_TILT_Initialise_post = SET_EVENT;
      //      moduleSendEvent("MAST_TILT_Initialise_post;");
