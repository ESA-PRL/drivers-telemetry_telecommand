#ifndef ORC_MOD_SA_LEFT_Primary_MoveTo_H
#define ORC_MOD_SA_LEFT_Primary_MoveTo_H
...
namespace ControllerModelNamespace {
 ...
 /**
   * \brief Implements the **SA_LEFT_PrimaryMoveTo** Action. Move LEFT Solar Arrays primary hinge motor.
   */
  class orc_Mod_SA_LEFT_Primary_MoveTo // : public ModuleAlgo
{
 public:
	int rtId;     // Action Id
	int index;
 ...
 public:
  orc_Mod_SA_LEFT_Primary_MoveTo (/*ModuleTask* mt, 
				    int indexclk*/);
  virtual ~orc_Mod_SA_LEFT_Primary_MoveTo ();

 public:
  // Output Event Ports declaration
  int SA_LEFT_Primary_MoveTo_prec;
int SA_LEFT_Primary_MoveTo_post;
