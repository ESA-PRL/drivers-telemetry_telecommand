...
orc_Mod_MAST_TILT_SwitchOff::~orc_Mod_MAST_TILT_SwitchOff ()
{
  //  PRINT1( "** orc_Mod_MAST_TILT_SwitchOff destructor" )
}
...
void orc_Mod_MAST_TILT_SwitchOff::reparam (char *params)
{
  //  fprintf( stderr, "MAST_TILT_SwitchOff: reparam\n" );
  // #include   "MAST_TILT_SwitchOff/user_code/reparam_code.c"
}
...
void orc_Mod_MAST_TILT_SwitchOff::init ()
{
  // std::cerr << "MAST_TILT_SwitchOff: init" << std::endl;
	...
	MAST_TILT_SwitchOff_post = NO_EVENT;
	...
	MAST_TILT_SwitchOff_prec = SET_EVENT;
	//	moduleSendEvent("MAST_TILT_SwitchOff_prec;");

}

void orc_Mod_MAST_TILT_SwitchOff::compute ()
{
  //  std::cerr << "-> MAST_TILT_SwitchOff: start compute" << std::endl;
	/*
	 * Get the MastState variable
	 */
	if ( theRobotProcedure->GetParameters()->get("MastState", DOUBLE,
	...
	if (index >= (duration/0.2)) {
	  ...
	  MAST_TILT_SwitchOff_post = SET_EVENT;
	  //	  moduleSendEvent("MAST_TILT_SwitchOff_post;");
	  MastState[MAST_ACTION_ID_INDEX]  = rtId;
...
// End class orc_Mod_MAST_TILT_SwitchOff
