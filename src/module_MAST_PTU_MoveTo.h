#ifndef ORC_MOD_MAST_PTU_MoveTo_H
#define ORC_MOD_MAST_PTU_MoveTo_H
...
namespace ControllerModelNamespace {
  ...
  class orc_Mod_MAST_PTU_MoveTo // : public ModuleAlgo
{
 public:
 ...
 public:
  orc_Mod_MAST_PTU_MoveTo (/*ModuleTask* mt,  
			     int indexclk*/);
  virtual ~orc_Mod_MAST_PTU_MoveTo ();

  // Output Event Ports declaration
  int MAST_PTU_MoveTo_prec; 
  int MAST_PTU_MoveTo_post;
