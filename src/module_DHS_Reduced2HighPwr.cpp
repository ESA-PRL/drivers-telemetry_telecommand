...
orc_Mod_DHS_Reduced2HighPwr::~orc_Mod_DHS_Reduced2HighPwr ()
{
  //  PRINT1( "** orc_Mod_DHS_Reduced2HighPwr destructor" )
}
...
void orc_Mod_DHS_Reduced2HighPwr::reparam (char *params)
{
  //  fprintf( stderr, "DHS_Reduced2HighPwr:: reparam\n" );
 //   #include   "DHS_Reduced2HighPwr/user_code/reparam_code.c"
}
...
void orc_Mod_DHS_Reduced2HighPwr::init ()
{
  std::cerr << "-> DHS_Reduced2HighPwr: start init" << std::endl;
	...
	*/
	...
	//
	DHS_Reduced2HighPwr_prec = SET_EVENT;
	//	moduleSendEvent("DHS_Reduced2HighPwr_prec;");

}

void orc_Mod_DHS_Reduced2HighPwr::compute ()
{
  ...
  rtId = 12; //Mt_ptr->GetRobotTaskPtr()->GetId();
	...
	if (index >= (duration/0.2))
	{
	  ...
	  DHS_Reduced2HighPwr_post = SET_EVENT;
	  //	  moduleSendEvent("DHS_Reduced2HighPwr_post;");
	}
