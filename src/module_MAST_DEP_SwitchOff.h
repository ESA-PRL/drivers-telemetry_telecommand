#ifndef ORC_MOD_MAST_DEP_SwitchOff_H
#define ORC_MOD_MAST_DEP_SwitchOff_H
...
namespace ControllerModelNamespace {
  ...
  class orc_Mod_MAST_DEP_SwitchOff // : public ModuleAlgo
{
 public:
 ...
 public:
  orc_Mod_MAST_DEP_SwitchOff (/*ModuleTask* mt, int indexclk*/);
  virtual ~orc_Mod_MAST_DEP_SwitchOff ();
  
  // Output Event Ports declaration
  int MAST_DEP_SwitchOff_prec;
  int MAST_DEP_SwitchOff_post;
