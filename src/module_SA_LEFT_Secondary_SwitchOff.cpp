...
orc_Mod_SA_LEFT_Secondary_SwitchOff::~orc_Mod_SA_LEFT_Secondary_SwitchOff ()
{
  //  PRINT1( "** orc_Mod_SA_LEFT_Secondary_SwitchOff destructor" )
}
...
{
  //  fprintf( stderr, "SA_LEFT_Secondary_SwitchOff:: reparam\n" );
  // #include   "SA_LEFT_Secondary_SwitchOff/user_code/reparam_code.c"
}
...
void orc_Mod_SA_LEFT_Secondary_SwitchOff::init ()
{
  //  std::cerr << "-> SA_LEFT_Secondary_SwitchOff: start init" << std::endl;
	...
	*/
	...
	SA_LEFT_Secondary_SwitchOff_prec = SET_EVENT;

	//	moduleSendEvent("SA_LEFT_Secondary_SwitchOff_prec;");

}

void orc_Mod_SA_LEFT_Secondary_SwitchOff::compute ()
{
  //  std::cerr << "-> SA_LEFT_Secondary_SwitchOff: start compute" << std::endl;
	if ( theRobotProcedure->GetParameters()->get( "SolarArrayState", DOUBLE,
	                                              MAX_STATE_SIZE, 0,
	                                              ( char * ) SolarArrayState ) == ERROR ) {
	  //		theRobotProcedure->ExitOnMissingStateSymbol(
	...
	if (index >= 10) {
	  ...
	  SolarArrayState[SA_LEFT_SECONDARY_STATUS_INDEX] = SA_OPER_MODE_OFF; 

	  SA_LEFT_Secondary_SwitchOff_post = SET_EVENT;
	  //	  moduleSendEvent("SA_LEFT_Secondary_SwitchOff_post;");
	}
