  ...
  class orc_Mod_SA_RIGHT_Secondary_MoveTo : public ModuleAlgo
{
 ...
 public:
  orc_Mod_SA_RIGHT_Secondary_MoveTo (/* ModuleTask* mt, 
					int indexclk */);
  virtual ~orc_Mod_SA_RIGHT_Secondary_MoveTo ();

 public:
  // Output Event Ports declaration
  int SA_RIGHT_Secondary_MoveTo_prec;
int SA_RIGHT_Secondary_MoveTo_post;
