...
void orc_Mod_Deploy_LEFT_SA::param (char *params)
{
  ...
  //  fprintf (stderr, "Deploy_LEFT_SA:: param\n");
  ...
  /*
	...
	sprintf(start_task_event, "Deploy_LEFT_SA_start;");
...
{
  //  fprintf( stderr, "Deploy_LEFT_SA:: reparam\n" );
  // #include   "Deploy_LEFT_SA/user_code/reparam_code.c"
}
...
void orc_Mod_Deploy_LEFT_SA::init ()
{
  //  std::cerr << "-> Deploy_LEFT_SA: start init" << std::endl;
	...
	Deploy_LEFT_SA_prec  = SET_EVENT;
	moduleSendEvent("Deploy_LEFT_SA_prec;");
	*/
