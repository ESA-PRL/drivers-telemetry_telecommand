...
orc_Mod_SA_LEFT_Secondary_MoveTo::~orc_Mod_SA_LEFT_Secondary_MoveTo ()
{
  //  PRINT1( "** orc_Mod_SA_LEFT_Secondary_MoveTo destructor" )
}
...
void orc_Mod_SA_LEFT_Secondary_MoveTo::reparam (char *params)
{
  //  fprintf( stderr, "SA_LEFT_Secondary_MoveTo:: reparam\n" );
 // #include   "SA_LEFT_Secondary_MoveTo/user_code/reparam_code.c"
}
...
void orc_Mod_SA_LEFT_Secondary_MoveTo::init ()
{
  std::cerr << "-> SA_LEFT_Secondary_MoveTo: init" << std::endl;
	...
	if ( SolarArrayState[SA_LEFT_PRIMARY_STATUS_INDEX] != SA_OPER_MODE_STNDBY ) {
	  ...
	  fprintf(stderr, "In SA_LEFT_Secondary_MoveTo::init() SA STATUS is not SA_OPER_MODE_STNDBY as expected\n");
	  return;
	 }
	 */
	...
	SolarArrayState[SA_LEFT_SECONDARY_STATUS_INDEX] = SA_OPER_MODE_MOVING;
	...
	*/
	...
	//
	SA_LEFT_Secondary_MoveTo_prec = SET_EVENT;
	//	moduleSendEvent("SA_LEFT_Secondary_MoveTo_prec;");


	//	adeManagement.resetFlags();
}

void orc_Mod_SA_LEFT_Secondary_MoveTo::compute ()
{
  //  std::cerr << "-> SA_LEFT_Secondary_MoveTo: start compute" << std::endl;
  
  //  if (adeManagement.ActivateADE() == 1) 
  //    return;

  //  if (adeManagement.DeactivateADE("SA_LEFT_Secondary_MoveTo_post;") == 1) 
  //    return;
	...
	if (coordinatedMotion == 1) {
	  ...
	  if (currentTime <= trajDuration) {
	    ...
	    SA_LEFT_Secondary_MoveTo_post = SET_EVENT;
	    //moduleSendEvent("SA_LEFT_Secondary_MoveTo_post;");
